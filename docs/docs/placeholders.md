...
Leaderboard placeholders use the same background-refreshed snapshots as `/baltop`, controlled by `baltop.cache-ttl-seconds` in config. Lower values give fresher data at the cost of more sorting work.
